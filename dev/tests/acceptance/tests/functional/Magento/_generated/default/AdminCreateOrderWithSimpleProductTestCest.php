 ...
 * @Description("Create order with simple product and assert if it gets out of stock after ordering it.<h3>Test files</h3>vendor\magento\module-sales\Test\Mftf\Test\AdminCreateOrderWithSimpleProductTest.xml<br>")
 * @TestCaseId("MC-22110")
 * @group Sales
 * @group mtf_migrated
 */
