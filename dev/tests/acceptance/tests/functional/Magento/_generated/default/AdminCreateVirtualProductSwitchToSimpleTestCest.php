 ...
 * @Description("After selecting a virtual product when adding Admin should be switch to simple implicitly<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminCreateAndSwitchProductType\AdminCreateVirtualProductSwitchToSimpleTest.xml<br>")
 * @TestCaseId("MC-10928")
 * @group catalog
 * @group mtf_migrated
 */
