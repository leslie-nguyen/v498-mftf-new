 ...
 * @Description("Admin should be able to create active text checkout agreement<h3>Test files</h3>vendor\magento\module-checkout-agreements\Test\Mftf\Test\AdminCreateActiveTextTermEntityTest.xml<br>")
 * @TestCaseId("MC-14667")
