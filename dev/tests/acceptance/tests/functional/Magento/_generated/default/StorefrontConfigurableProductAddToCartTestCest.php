 ...
 * @Description("customer should be taken to the product details page when clicking add to cart<h3>Test files</h3>vendor\magento\module-configurable-product\Test\Mftf\Test\StorefrontConfigurableProductViewTest\StorefrontConfigurableProductAddToCartTest.xml<br>")
 * @TestCaseId("MC-89")
...
class StorefrontConfigurableProductAddToCartTestCest
{
	...
	public function StorefrontConfigurableProductAddToCartTest(AcceptanceTester $I)
	{
		...
		$I->click("button.action.tocart.primary"); // stepKey: clickAddToCart
		$I->waitForPageLoad(30); // stepKey: wait3
		$grabUrl = $I->grabFromCurrentUrl(); // stepKey: grabUrl
		$I->assertStringContainsString("testurlkey" . msq("_defaultProduct"), $grabUrl); // stepKey: assertUrl
	}
}
