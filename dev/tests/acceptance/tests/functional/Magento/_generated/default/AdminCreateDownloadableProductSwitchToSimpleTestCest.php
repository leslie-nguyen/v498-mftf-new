 ...
 * @Description("After selecting a downloadable product when adding Admin should be switch to simple implicitly<h3>Test files</h3>vendor\magento\module-downloadable\Test\Mftf\Test\AdminCreateDownloadableProductSwitchToSimpleTest.xml<br>")
 * @TestCaseId("MC-10929")
 * @group catalog
 * @group mtf_migrated
 */
