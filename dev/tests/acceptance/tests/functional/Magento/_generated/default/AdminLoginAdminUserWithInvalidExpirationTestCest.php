 ...
 * @Description("Try to login as a user with an invalid expiration date.<h3>Test files</h3>vendor\magento\module-security\Test\Mftf\Test\AdminLoginAdminUserWithInvalidExpirationTest.xml<br>")
 * @TestCaseId("")
 * @group security
 */
