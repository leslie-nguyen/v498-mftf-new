 ...
 * @Description("Login as admin and check the configurable product price when one child product is out of stock<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminCheckConfigurableProductPriceWithOutOfStockChildProductTest.xml<br>")
 * @TestCaseId("MC-13750")
 * @group mtf_migrated
 */
class AdminCheckConfigurableProductPriceWithOutOfStockChildProductTestCest
{
	...
	public function AdminCheckConfigurableProductPriceWithOutOfStockChildProductTest(AcceptanceTester $I)
	{
		...
		$I->selectOption("select[name='product[quantity_and_stock_status][is_in_stock]']", "Out of Stock"); // stepKey: selectOutOfStock
		$I->waitForPageLoad(30); // stepKey: selectOutOfStockWaitForPageLoad
