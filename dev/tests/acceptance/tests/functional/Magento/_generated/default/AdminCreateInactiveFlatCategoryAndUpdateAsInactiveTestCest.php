 ...
 * @Description("Login as admin and create inactive flat category and update category as inactive and verify category is not visible in store front<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminCreateInactiveFlatCategoryAndUpdateAsInactiveTest.xml<br>")
 * @TestCaseId("MC-11009")
 * @group mtf_migrated
 */
