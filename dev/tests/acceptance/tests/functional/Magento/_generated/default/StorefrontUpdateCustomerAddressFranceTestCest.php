 ...
 * @Description("Test log in to Storefront and Update Customer Address (France) in Storefront<h3>Test files</h3>vendor\magento\module-customer\Test\Mftf\Test\StorefrontUpdateCustomerAddressFranceTest.xml<br>")
 * @TestCaseId("MC-10912")
 * @group customer
 * @group mtf_migrated
 */
class StorefrontUpdateCustomerAddressFranceTestCest
{
	...
	public function StorefrontUpdateCustomerAddressFranceTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#firstname", "Jaen"); // stepKey: fillFirstNameEnterAddress
		...
		$I->comment("Verify customer default billing address");
		$I->see("Jaen Reno", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressFirstnameAndLastnameVerifyBillingAddress
		...
		$I->comment("Verify customer default shipping address");
		$I->see("Jaen Reno", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressFirstnameAndLastnameVerifyShippingAddress
