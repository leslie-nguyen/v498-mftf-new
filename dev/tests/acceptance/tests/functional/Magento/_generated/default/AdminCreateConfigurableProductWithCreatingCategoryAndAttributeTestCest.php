 ...
 * @Description("Admin should be able to create configurable product with creating new category and new attribute (required fields only)<h3>Test files</h3>vendor\magento\module-configurable-product\Test\Mftf\Test\AdminCreateConfigurableProductWithCreatingCategoryAndAttributeTest.xml<br>")
 * @TestCaseId("MC-13687")
 * @group mtf_migrated
 */
