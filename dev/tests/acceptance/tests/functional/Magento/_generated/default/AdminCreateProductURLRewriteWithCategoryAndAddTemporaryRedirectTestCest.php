 ...
 * @Description("Login as admin, create product with category and UrlRewrite and add temporary redirect<h3>Test files</h3>vendor\magento\module-url-rewrite\Test\Mftf\Test\AdminCreateProductURLRewriteWithCategoryAndAddTemporaryRedirectTest.xml<br>")
 * @TestCaseId("MC-5338")
 * @group mtf_migrated
 */
class AdminCreateProductURLRewriteWithCategoryAndAddTemporaryRedirectTestCest
{
	...
	public function AdminCreateProductURLRewriteWithCategoryAndAddTemporaryRedirectTest(AcceptanceTester $I)
	{
		...
		$I->fillField(".admin__data-grid-filters input[name='request_path']", "firstlevelsubcategory" . msq("FirstLevelSubCat") . "/testurlkey" . msq("_defaultProduct") . ".html"); // stepKey: fillRedirectPathFilterSearchByRequestPath
		...
		$I->see("firstlevelsubcategory" . msq("FirstLevelSubCat") . "/testurlkey" . msq("_defaultProduct") . ".html", "//*[@data-role='grid']//tbody//tr[1+1]//td[count(//*[@data-role='grid']//th[contains(., 'Request Path')]/preceding-sibling::th)+1]"); // stepKey: seeTheRedirectPathForOldUrlSearchByRequestPath
