...
/**
 * @Description("run sample test<h3>Test files</h3>app\code\Cafedu\Theme\Test\Mftf\Test\runTest.xml<br>")
 * @TestCaseId("sample")
 * @group test
 */
class RunTestCest
{
	...
	public function RunTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage("QuickGoThroughData1.cateListingUrl"); // stepKey: redirectToTargetPageAccessPageAndVerifyJSError
