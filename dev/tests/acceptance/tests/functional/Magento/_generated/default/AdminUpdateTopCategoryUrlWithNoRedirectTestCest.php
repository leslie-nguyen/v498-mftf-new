 ...
 * @Description("Login as admin and update top category url and do not create redirect<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminUpdateTopCategoryUrlWithNoRedirectTest.xml<br>")
 * @TestCaseId("MC-6056")
 * @group Catalog
 * @group mtf_migrated
 */
