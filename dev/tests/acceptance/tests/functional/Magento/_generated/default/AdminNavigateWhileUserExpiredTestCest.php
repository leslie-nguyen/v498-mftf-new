 ...
 * @Description("Navigate to an admin page after user expiration date passes.<h3>Test files</h3>vendor\magento\module-security\Test\Mftf\Test\AdminNavigateWhileUserExpiredTest.xml<br>")
 * @TestCaseId("")
 * @group security
 */
class AdminNavigateWhileUserExpiredTestCest
{
	...
	public function AdminNavigateWhileUserExpiredTest(AcceptanceTester $I)
	{
		...
		$I->seeInCurrentUrl((getenv("MAGENTO_BACKEND_BASE_URL") ? rtrim(getenv("MAGENTO_BACKEND_BASE_URL"), "/") : "") . "/" . getenv("MAGENTO_BACKEND_NAME") . "/admin"); // stepKey: seeAdminLoginUrl
