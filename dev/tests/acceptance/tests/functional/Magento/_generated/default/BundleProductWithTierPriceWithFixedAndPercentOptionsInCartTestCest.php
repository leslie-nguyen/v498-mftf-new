 ...
 * @Description("Customer should be able to add bundle product with tier price and bundle items with fixed and percent price to the cart and get the right price<h3>Test files</h3>vendor\magento\module-bundle\Test\Mftf\Test\BundleProductWithTierPriceWithFixedAndPercentOptionsInCartTest.xml<br>")
 * @TestCaseId("MC-26543")
 * @group bundle
 * @group catalog
 */
