 ...
 * @Description("Create Credit Memo with cash on delivery payment and assert 0 shipping refund<h3>Test files</h3>vendor\magento\module-sales\Test\Mftf\Test\AdminCreateCreditMemoWithCashOnDeliveryTest.xml<br>")
 * @TestCaseId("MC-15863")
 * @group sales
 * @group mtf_migrated
 */
class AdminCreateCreditMemoWithCashOnDeliveryTestCest
{
	 ...
	 * @throws \Exception
	 */
	public function AdminCreateCreditMemoWithCashOnDeliveryTest(AcceptanceTester $I)
	{
