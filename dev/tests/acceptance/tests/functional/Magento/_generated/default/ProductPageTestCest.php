...
class ProductPageTestCest
{
	...
	public function ProductPageTest(AcceptanceTester $I)
	{
		...
		$I->comment("<amOnPage url=\"/\{\{storeCode.fr_fr\}\}/\{\{QuickGoThroughData.pdpUrl\}\}\" stepKey=\"amOnProductPage\"/>");
		$I->comment("Entering Action Group [amOnPage] AmOnPageForMultiStoreviewsActionGroup");
		$I->amOnPage("/{{fr_fr}}//men-cycling-jersey-floriane-petunia.html"); // stepKey: amOnProductPageAmOnPage
		$I->comment("Exiting Action Group [amOnPage] AmOnPageForMultiStoreviewsActionGroup");
