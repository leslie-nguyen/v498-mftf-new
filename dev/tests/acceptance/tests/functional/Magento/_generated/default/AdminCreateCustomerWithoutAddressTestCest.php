 ...
 * @Description("Login as admin and create a customer without address<h3>Test files</h3>vendor\magento\module-customer\Test\Mftf\Test\AdminCreateCustomerWithoutAddressTest.xml<br>")
 * @TestCaseId("MC-5307")
 * @group mtf_migrated
 */
