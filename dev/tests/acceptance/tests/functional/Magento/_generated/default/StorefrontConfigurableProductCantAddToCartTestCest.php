 ...
 * @Description("Guest customer should not be able to add the product to the cart if options are not selected<h3>Test files</h3>vendor\magento\module-configurable-product\Test\Mftf\Test\StorefrontConfigurableProductDetailsTest\StorefrontConfigurableProductCantAddToCartTest.xml<br>")
 * @TestCaseId("MC-81")
...
class StorefrontConfigurableProductCantAddToCartTestCest
{
	...
	public function StorefrontConfigurableProductCantAddToCartTest(AcceptanceTester $I)
	{
		...
		$I->see("This is a required field", "//div[@class='mage-error']"); // stepKey: seeError
	}
}
