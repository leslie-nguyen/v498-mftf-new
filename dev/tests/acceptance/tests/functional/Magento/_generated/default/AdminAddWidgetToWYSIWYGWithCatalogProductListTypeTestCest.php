 ...
 * @Description("Admin should be able to create a CMS page with widget type: Catalog product list<h3>Test files</h3>vendor\magento\module-cms\Test\Mftf\Test\AdminAddWidgetToWYSIWYGWithCatalogProductListTypeTest.xml<br>")
