 ...
 * @Description("Admin should be able to navigate to Content > Themes<h3>Test files</h3>vendor\magento\module-theme\Test\Mftf\Test\AdminContentThemesNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14112")
 * @group menu
 * @group mtf_migrated
 */
