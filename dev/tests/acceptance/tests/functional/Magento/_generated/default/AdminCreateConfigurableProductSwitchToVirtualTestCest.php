 ...
 * @Description("After selecting a configurable product when adding Admin should be switch to virtual implicitly<h3>Test files</h3>vendor\magento\module-configurable-product\Test\Mftf\Test\AdminCreateAndSwitchProductType\AdminCreateConfigurableProductSwitchToVirtualTest.xml<br>")
 * @TestCaseId("MC-10927")
 * @group catalog
 * @group mtf_migrated
 */
