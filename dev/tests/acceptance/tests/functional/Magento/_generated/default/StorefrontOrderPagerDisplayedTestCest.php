 ...
 * @Description("Pager is displayed for 21 order items<h3>Test files</h3>vendor\magento\module-sales\Test\Mftf\Test\StorefrontOrderPagerDisplayedTest.xml<br>")
 * @TestCaseId("MC-16167")
 * @group sales
 * @group mtf_migrated
 */
class StorefrontOrderPagerDisplayedTestCest
{
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->comment("Reindex and flush the cache to display products on the category page");
