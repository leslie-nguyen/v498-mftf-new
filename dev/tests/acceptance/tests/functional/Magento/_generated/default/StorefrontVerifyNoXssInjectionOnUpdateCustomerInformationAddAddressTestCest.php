...
/**
 * @Title("MC-10910: [Security] Verify No XSS Injection on Update Customer Information Add Address")
 * @Description("Test log in to Storefront and Verify No XSS Injection on Update Customer Information Add Address<h3>Test files</h3>vendor\magento\module-customer\Test\Mftf\Test\StorefrontVerifyNoXssInjectionOnUpdateCustomerInformationAddAddressTest.xml<br>")
 * @TestCaseId("MC-10910")
 * @group customer
 * @group mtf_migrated
 */
class StorefrontVerifyNoXssInjectionOnUpdateCustomerInformationAddAddressTestCest
{
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->fillField("#firstname", "Patrick</title></head><svg/onload=alert('XSS')>"); // stepKey: fillFirstNameFillCreateAccountForm
		$I->fillField("#lastname", "<script>alert('Last name')</script>"); // stepKey: fillLastNameFillCreateAccountForm
		$I->fillField("#email_address", msq("Colorado_US_Customer") . "Patric.Patric@example.com"); // stepKey: fillEmailFillCreateAccountForm
		$I->fillField("#password", "123123^q"); // stepKey: fillPasswordFillCreateAccountForm
		$I->fillField("#password-confirmation", "123123^q"); // stepKey: fillConfirmPasswordFillCreateAccountForm
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("input[name=email]", msq("Colorado_US_Customer") . "Patric.Patric@example.com"); // stepKey: filterEmailDeleteNewUser
	 ...
	 * @throws \Exception
	 */
	public function StorefrontVerifyNoXssInjectionOnUpdateCustomerInformationAddAddressTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#firstname", "Jany"); // stepKey: fillFirstNameEnterAddress
		...
		$I->fillField("#street_1", "7700 West Parmer Lane"); // stepKey: fillStreetAddress1EnterAddress
		$I->fillField("#street_2", "7700 West Parmer Lane"); // stepKey: fillStreetAddress2EnterAddress
		$I->fillField("#city", "Denver"); // stepKey: fillCityNameEnterAddress
		$I->selectOption("#country", "US"); // stepKey: selectCountyEnterAddress
		$I->selectOption("#region_id", "Colorado"); // stepKey: selectStateEnterAddress
		...
		$I->comment("Verify customer default billing address");
		$I->see("Jany Doe", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressFirstnameAndLastnameVerifyBillingAddress
		$I->see("Magento", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressCompanyVerifyBillingAddress
		$I->see("7700 West Parmer Lane", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressStreetVerifyBillingAddress
		$I->see("7700 West Parmer Lane", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressStreet1VerifyBillingAddress
		$I->see("Denver, Colorado, 12345", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressCityAndPostcodeVerifyBillingAddress
		$I->see("United States", ".box-address-billing"); // stepKey: seeAssertCustomerDefaultBillingAddressCountryVerifyBillingAddress
		...
		$I->comment("Verify customer default shipping address");
		$I->see("Jany Doe", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressFirstnameAndLastnameVerifyShippingAddress
		$I->see("Magento", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressCompanyVerifyShippingAddress
		$I->see("7700 West Parmer Lane", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressStreetVerifyShippingAddress
		$I->see("7700 West Parmer Lane", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressStreet1VerifyShippingAddress
		$I->see("Denver, Colorado, 12345", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressCityAndPostcodeVerifyShippingAddress
		$I->see("United States", ".box-address-shipping"); // stepKey: seeAssertCustomerDefaultShippingAddressCountryVerifyShippingAddress
		...
		$I->seeInField("#firstname", "Patrick</title></head><svg/onload=alert('XSS')>"); // stepKey: seeAssertCustomerFirstNameVerifyVerifyCustomerName
		$I->seeInField("#lastname", "<script>alert('Last name')</script>"); // stepKey: seeAssertCustomerLastNameVerifyVerifyCustomerName
