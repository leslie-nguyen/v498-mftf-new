...
/**
 * @Title("MC-14009: Export grouped product with special price")
 * @Description("Admin should be able to export grouped product with special price<h3>Test files</h3>vendor\magento\module-catalog-import-export\Test\Mftf\Test\AdminExportGroupedProductWithSpecialPriceTest.xml<br>")
 * @TestCaseId("MC-14009")
