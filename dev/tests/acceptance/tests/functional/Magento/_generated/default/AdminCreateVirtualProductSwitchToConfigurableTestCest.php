 ...
 * @Description("After selecting a virtual product when adding Admin should be switch to configurable implicitly<h3>Test files</h3>vendor\magento\module-configurable-product\Test\Mftf\Test\AdminCreateAndSwitchProductType\AdminCreateVirtualProductSwitchToConfigurableTest.xml<br>")
 * @TestCaseId("MC-10930")
 * @group catalog
 * @group mtf_migrated
 */
