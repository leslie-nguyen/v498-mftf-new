...
/**
 * @Description("Check display Shop page<h3>Test files</h3>app\code\Cafedu\Theme\Test\Mftf\Test\ShopPageTest.xml<br>")
 * @TestCaseId("QUICK-SHOPPAGE01")
 * @group QuickGoThrough
 */
class ShopPageTestCest
{
    /**
	...
	/**
	 * @Features({"Theme"})
	 * @Stories({"Check display Shop page"})
	 ...
	 * @throws \Exception
	 */
	public function ShopPageTest(AcceptanceTester $I)
	{
		$I->comment("Access Shop page");
		...
		$I->amOnPage("/en_row/shops"); // stepKey: redirectToTargetPageAccessPageAndVerifyJSError
 ...
 so there will be no needed to verify in this action group anymore");
		...
		$I->comment("Verify main Shop page");
		...
		$I->seeElement("#maincontent"); // stepKey: verifyMainContentBlockDisplayed
		$I->makeScreenshot("ShopPageScreenshot"); // stepKey: screenshotShopPage
