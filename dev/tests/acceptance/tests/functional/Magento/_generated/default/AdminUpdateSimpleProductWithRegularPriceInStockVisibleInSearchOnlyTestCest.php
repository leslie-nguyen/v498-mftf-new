 ...
 * @Description("Test log in to Update Simple Product and Update Simple Product with Regular Price (In Stock) Visible in Search Only<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminUpdateSimpleProductWithRegularPriceInStockVisibleInSearchOnlyTest.xml<br>")
 * @TestCaseId("MC-10805")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateSimpleProductWithRegularPriceInStockVisibleInSearchOnlyTestCest
{
	...
	public function AdminUpdateSimpleProductWithRegularPriceInStockVisibleInSearchOnlyTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage("/test-simple-product" . msq("simpleProductRegularPrice325InStock") . ".html"); // stepKey: goToProductPage
		$I->waitForPageLoad(30); // stepKey: waitForStorefrontProductPageLoad
		$I->see("TestSimpleProduct" . msq("simpleProductRegularPrice325InStock"), ".base"); // stepKey: seeSimpleProductNameOnStoreFrontPage
		$I->see("325.02", "div.price-box.price-final_price"); // stepKey: seeSimpleProductPriceOnStoreFrontPage
		...
		$I->assertEquals("$325.02", $productPriceAmount); // stepKey: assertOldPriceTextOnProductPage
		...
		$I->waitForPageLoad(30); // stepKey: waitForStoreFrontProductPageLoad
		$I->fillField("#search", "test_simple_product_sku" . msq("simpleProductRegularPrice325InStock")); // stepKey: fillSimpleProductSkuInSearchTextBox
		...
		$I->see("TestSimpleProduct" . msq("simpleProductRegularPrice325InStock"), "a[class='product-item-link']"); // stepKey: seeProductName
