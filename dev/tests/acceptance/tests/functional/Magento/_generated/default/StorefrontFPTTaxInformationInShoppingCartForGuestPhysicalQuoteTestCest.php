 ...
 * @Description("Tax information are updating/recalculating on fly in shopping cart for Guest (physical quote)<h3>Test files</h3>vendor\magento\module-weee\Test\Mftf\Test\StorefrontFPTTaxInformationInShoppingCartForGuestPhysicalQuoteTest.xml<br>")
 * @TestCaseId("MC-28592")
 * @group checkout
 * @group tax
 * @group weee
