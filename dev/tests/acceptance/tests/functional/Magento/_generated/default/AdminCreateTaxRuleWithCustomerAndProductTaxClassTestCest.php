 ...
 * @Description("Test log in to Tax Rule and Create tax rule with customer and product tax class<h3>Test files</h3>vendor\magento\module-tax\Test\Mftf\Test\AdminCreateTaxRuleWithCustomerAndProductTaxClassTest.xml<br>")
 * @TestCaseId("MC-5324")
 * @group tax
 * @group mtf_migrated
 */
