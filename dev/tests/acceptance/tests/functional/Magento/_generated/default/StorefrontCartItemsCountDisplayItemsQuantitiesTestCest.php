 ...
 * @Description("Items count in shopping cart and on checkout page should be consistent with settings 'checkout/cart_link/use_qty'<h3>Test files</h3>vendor\magento\module-checkout\Test\Mftf\Test\StorefrontCheckCartAndCheckoutItemsCountTest\StorefrontCartItemsCountDisplayItemsQuantitiesTest.xml<br>")
 * @TestCaseId("MC-18281")
 * @group checkout
 */
class StorefrontCartItemsCountDisplayItemsQuantitiesTestCest
{
	...
	public function StorefrontCartItemsCountDisplayItemsQuantitiesTest(AcceptanceTester $I)
	{
		...
		$I->see("3 Items in Cart", "//div[@class='title']"); // stepKey: seeOrderSummaryTextAssertProductCountOnCheckoutPage
