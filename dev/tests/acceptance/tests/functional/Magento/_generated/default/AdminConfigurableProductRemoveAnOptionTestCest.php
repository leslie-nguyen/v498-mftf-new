 ...
 * @Description("Admin should be able to remove a product configuration<h3>Test files</h3>vendor\magento\module-configurable-product\Test\Mftf\Test\AdminConfigurableProductUpdateTest\AdminConfigurableProductRemoveAnOptionTest.xml<br>")
 * @TestCaseId("MC-63")
...
class AdminConfigurableProductRemoveAnOptionTestCest
{
	...
	public function AdminConfigurableProductRemoveAnOptionTest(AcceptanceTester $I)
	{
		...
		$I->see($I->retrieveEntityField('createConfigChildProduct1', 'name', 'test'), ".admin__control-fields[data-index='name_container']"); // stepKey: seeOption1Admin
		$I->see($I->retrieveEntityField('createConfigChildProduct2', 'name', 'test'), ".admin__control-fields[data-index='name_container']"); // stepKey: seeOption2Admin
