...
/**
 * @Description("Check display category landing page<h3>Test files</h3>app\code\Cafedu\Theme\Test\Mftf\Test\CateLandingPageTest.xml<br>")
 * @TestCaseId("QUICK-CATE01")
 * @group QuickGoThrough
 */
class CateLandingPageTestCest
{
    /**
	...
	/**
	 * @Features({"Theme"})
	 * @Stories({"Check display category landing page"})
	 ...
	 * @throws \Exception
	 */
	public function CateLandingPageTest(AcceptanceTester $I)
	{
		$I->comment("Access Category landing page");
 ...
 so there will be no needed to verify in this action group anymore");
		...
		$I->comment("Verify banner and banner text  content Category landing page");
		$I->seeElement("div.inner-banner"); // stepKey: verifyBannerDisplayed
		$I->seeElement(".text-holder"); // stepKey: verifyBannerTextDisplayed
		$I->makeScreenshot("CateLandingPageHeaderAndBannerScreenshot"); // stepKey: screenshotCateLandingPageHeaderAndBanner
		...
		$I->scrollTo(".breadcrumbs ul"); // stepKey: scrollToBreadcrumb
		$I->comment("Verify main content Category landing page");
		$I->seeElement(".category-cms .page-container"); // stepKey: verifyMainContentBlockDisplayed
		$I->waitForAjaxLoad(30); // stepKey: waitForAjaxLoad
		$I->makeScreenshot("CateLandingPageMainContentScreenshot"); // stepKey: screenshotCateLandingPageMainContent
