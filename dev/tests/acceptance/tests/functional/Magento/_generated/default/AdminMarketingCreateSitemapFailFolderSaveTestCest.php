 ...
 * @Description("Sitemap Entity Creation Fail Folder Save<h3>Test files</h3>vendor\magento\module-sitemap\Test\Mftf\Test\AdminMarketingCreateSitemapFailFolderSaveTest.xml<br>")
 * @TestCaseId("MC-14314")
 * @group sitemap
 * @group mtf_migrated
 */
