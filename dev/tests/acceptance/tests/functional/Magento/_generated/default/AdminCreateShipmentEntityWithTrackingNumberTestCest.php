 ...
 * @Description("Admin Should be Able to Create Shipments<h3>Test files</h3>vendor\magento\module-shipping\Test\Mftf\Test\AdminCreateShipmentEntityTest.xml<br>")
 * @TestCaseId("MC-14330")
 * @group sales
 * @group mtf_migrated
 */
