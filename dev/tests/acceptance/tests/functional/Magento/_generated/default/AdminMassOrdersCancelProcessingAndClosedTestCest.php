 ...
 * @Description("Try to cancel orders in status Processing, Closed<h3>Test files</h3>vendor\magento\module-sales\Test\Mftf\Test\AdminMassOrdersCancelProcessingAndClosedTest.xml<br>")
 * @TestCaseId("MC-16184")
 * @group sales
 * @group mtf_migrated
 */
class AdminMassOrdersCancelProcessingAndClosedTestCest
{
	 ...
	 * @throws \Exception
	 */
	public function AdminMassOrdersCancelProcessingAndClosedTest(AcceptanceTester $I)
	{
		...
		$I->comment("Create Invoice for first Order");
