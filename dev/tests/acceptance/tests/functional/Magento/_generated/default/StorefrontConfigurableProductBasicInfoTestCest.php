 ...
 * @Description("Guest customer should see basic Configurable Product details<h3>Test files</h3>vendor\magento\module-configurable-product\Test\Mftf\Test\StorefrontConfigurableProductDetailsTest\StorefrontConfigurableProductBasicInfoTest.xml<br>")
 * @TestCaseId("MC-77")
...
class StorefrontConfigurableProductBasicInfoTestCest
{
	...
	public function StorefrontConfigurableProductBasicInfoTest(AcceptanceTester $I)
	{
		...
		$I->see("testSku" . msq("_defaultProduct"), ".product.attribute.sku>.value"); // stepKey: seeProductSku
		$I->see("As low as", ".price-label"); // stepKey: seeProductPriceLabel
		$I->see("IN STOCK", ".stock[title=Availability]>span"); // stepKey: seeProductStockStatus
		$I->see("1.00", "div.price-box.price-final_price"); // stepKey: seeProductPrice
		$I->see("Color" . msq("colorProductAttribute"), "#product-options-wrapper div[tabindex='0'] label"); // stepKey: seeProductAttributeTitle
		$I->see("Color" . msq("colorProductAttribute"), "#product-options-wrapper div[tabindex='0'] label"); // stepKey: seeColorAttributeName1
