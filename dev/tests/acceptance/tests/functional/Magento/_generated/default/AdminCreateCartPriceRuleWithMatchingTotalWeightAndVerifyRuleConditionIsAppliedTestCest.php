 ...
 * @Description("Test log in to Cart Price Rules and Create Cart Price Rule With Matching Total Weight And Verify Rule Condition Is Applied<h3>Test files</h3>vendor\magento\module-sales-rule\Test\Mftf\Test\AdminCreateCartPriceRuleWithMatchingTotalWeightAndVerifyRuleConditionIsAppliedTest.xml<br>")
 * @TestCaseId("MC-15609")
 * @group SalesRule
 * @group mtf_migrated
 */
class AdminCreateCartPriceRuleWithMatchingTotalWeightAndVerifyRuleConditionIsAppliedTestCest
{
	...
	public function AdminCreateCartPriceRuleWithMatchingTotalWeightAndVerifyRuleConditionIsAppliedTest(AcceptanceTester $I)
	{
		...
		$I->see("-$280.00", "td[data-th='Discount']"); // stepKey: seeAssertDiscountAmountAppliedForWeightConditionIsTrue
	}
}
