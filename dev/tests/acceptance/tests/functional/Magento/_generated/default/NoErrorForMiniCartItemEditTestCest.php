 ...
 * @Description("Already selected configurable option should be selected when configurable product is edited from minicart<h3>Test files</h3>vendor\magento\module-configurable-product\Test\Mftf\Test\NoErrorForMiniCartItemEditTest.xml<br>")
...
class NoErrorForMiniCartItemEditTestCest
{
	...
	public function NoErrorForMiniCartItemEditTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage("testurlkey" . msq("_defaultProduct") . ".html"); // stepKey: goToCreatedProductPage
