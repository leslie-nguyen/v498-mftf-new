 ...
 * @Description("Admin should be able to create disabled text checkout agreement<h3>Test files</h3>vendor\magento\module-checkout-agreements\Test\Mftf\Test\AdminCreateDisabledTextTermEntityTest.xml<br>")
 * @TestCaseId("MC-14669")
