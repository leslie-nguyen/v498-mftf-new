 ...
 * @Description("Use cart price rule of type Buy X get Y free with enable 'Apply to Shipping Amount'<h3>Test files</h3>vendor\magento\module-sales-rule\Test\Mftf\Test\AdminCreateBuyXGetYFreeWithApplyShippingAmountTest.xml<br>")
 * @group SalesRule
 */
class AdminCreateBuyXGetYFreeWithApplyShippingAmountTestCest
{
	...
	public function AdminCreateBuyXGetYFreeWithApplyShippingAmountTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage("testurlkey" . msq("_defaultProduct") . ".html"); // stepKey: goToProductPageVerifyStorefrontDiscount
