 ...
 * @Description("Login as admin and create customer with USA address<h3>Test files</h3>vendor\magento\module-customer\Test\Mftf\Test\AdminCreateCustomerWithCountryUSATest.xml<br>")
 * @TestCaseId("MC-5309")
 * @group mtf_migrated
 */
