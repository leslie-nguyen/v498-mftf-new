 ...
 * @Description("Test log in to Create Tax Rule and Create tax rule with New Tax Classes and Tax Rate<h3>Test files</h3>vendor\magento\module-tax\Test\Mftf\Test\AdminCreateTaxRuleWithNewTaxClassesAndTaxRateTest.xml<br>")
 * @TestCaseId("MC-5325")
 * @group tax
 * @group mtf_migrated
 */
