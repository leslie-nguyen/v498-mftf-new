 ...
 * @Description("Select one multi select option of a bundle product and add to the shopping cart<h3>Test files</h3>vendor\magento\module-checkout\Test\Mftf\Test\StorefrontAddOneBundleMultiSelectOptionToTheShoppingCartTest.xml<br>")
 * @TestCaseId("MC-14727")
 * @group mtf_migrated
 */
class StorefrontAddOneBundleMultiSelectOptionToTheShoppingCartTestCest
{
	...
	public function StorefrontAddOneBundleMultiSelectOptionToTheShoppingCartTest(AcceptanceTester $I)
	{
		...
		$I->waitForElementVisible("//*[@id='cart-totals']//tr[@class='grand totals']//td//span[@class='price' and contains(text(), '55.00')]", 30); // stepKey: waitForTotalAmountVisibleAssertCartSummary
