 ...
 * @Description("Customer should only see cart price rule discount if condition total items quantity greater than<h3>Test files</h3>vendor\magento\module-sales-rule\Test\Mftf\Test\StorefrontCartPriceRuleQuantityTest.xml<br>")
 * @TestCaseId("MC-236")
 * @group SalesRule
 */
class StorefrontCartPriceRuleQuantityTestCest
{
	...
	public function StorefrontCartPriceRuleQuantityTest(AcceptanceTester $I)
	{
		...
		$I->see("-$1.00", "td[data-th='Discount']"); // stepKey: seeDiscountTotal
	}
}
