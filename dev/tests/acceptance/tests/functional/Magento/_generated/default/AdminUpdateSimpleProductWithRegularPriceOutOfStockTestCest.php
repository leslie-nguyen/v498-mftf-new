 ...
 * @Description("Test log in to Update Simple Product and Update Simple Product with Regular Price (Out of Stock)<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminUpdateSimpleProductWithRegularPriceOutOfStockTest.xml<br>")
 * @TestCaseId("MC-10806")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateSimpleProductWithRegularPriceOutOfStockTestCest
{
	...
	public function AdminUpdateSimpleProductWithRegularPriceOutOfStockTest(AcceptanceTester $I)
	{
		...
		$I->fillField(".admin__field[data-index=name] input", "TestSimpleProduct" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: fillSimpleProductName
		$I->fillField(".admin__field[data-index=sku] input", "test_simple_product_sku" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: fillSimpleProductSku
		$I->fillField(".admin__field[data-index=price] input", "325.03"); // stepKey: fillSimpleProductPrice
		$I->fillField(".admin__field[data-index=qty] input", "25"); // stepKey: fillSimpleProductQuantity
		...
		$I->fillField(".admin__field[data-index=weight] input", "125"); // stepKey: fillSimpleProductWeight
		...
		$I->fillField("input[name='product[url_key]']", "test-simple-product" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: fillUrlKey
		...
		$I->fillField("input.admin__control-text[name='name']", "TestSimpleProduct" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: fillSimpleProductNameInNameFilter
		$I->fillField("input.admin__control-text[name='sku']", "test_simple_product_sku" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: fillProductSku
		...
		$I->seeInField(".admin__field[data-index=name] input", "TestSimpleProduct" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: seeSimpleProductName
		$I->seeInField(".admin__field[data-index=sku] input", "test_simple_product_sku" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: seeSimpleProductSku
		$I->seeInField(".admin__field[data-index=price] input", "325.03"); // stepKey: seeSimpleProductPrice
		$I->seeInField(".admin__field[data-index=qty] input", "25"); // stepKey: seeSimpleProductQuantity
		$I->seeInField("select[name='product[quantity_and_stock_status][is_in_stock]']", "Out of Stock"); // stepKey: seeSimpleProductStockStatus
		$I->waitForPageLoad(30); // stepKey: seeSimpleProductStockStatusWaitForPageLoad
		$I->seeInField(".admin__field[data-index=weight] input", "125"); // stepKey: seeSimpleProductWeight
		...
		$I->amOnPage("/test-simple-product" . msq("simpleProductRegularPrice32503OutOfStock") . ".html"); // stepKey: goToProductPage
		$I->waitForPageLoad(30); // stepKey: waitForStorefrontProductPageLoad
		$I->see("TestSimpleProduct" . msq("simpleProductRegularPrice32503OutOfStock"), ".base"); // stepKey: seeSimpleProductNameOnStoreFrontPage
		$I->see("325.03", "div.price-box.price-final_price"); // stepKey: seeSimpleProductPriceOnStoreFrontPage
		...
		$I->assertEquals("$325.03", $productPriceAmount); // stepKey: assertOldPriceTextOnProductPage
		$I->comment("Verify customer don't see updated simple product link on magento storefront page and is searchable by sku");
		$I->amOnPage("/test-simple-product" . msq("simpleProductRegularPrice32503OutOfStock") . ".html"); // stepKey: goToMagentoStorefrontPage
		$I->waitForPageLoad(30); // stepKey: waitForStoreFrontProductPageLoad
		$I->fillField("#search", "test_simple_product_sku" . msq("simpleProductRegularPrice32503OutOfStock")); // stepKey: fillSimpleProductSkuInSearchTextBox
		...
		$I->dontSee("TestSimpleProduct" . msq("simpleProductRegularPrice32503OutOfStock"), "a[class='product-item-link']"); // stepKey: dontSeeProductName
