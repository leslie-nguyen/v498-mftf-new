 ...
 * @Description("Verify that the category filter is present in layered navigation on category page<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\StorefrontCategoryPageWithCategoryFilterTest.xml<br>")
 * @group Catalog
 */
