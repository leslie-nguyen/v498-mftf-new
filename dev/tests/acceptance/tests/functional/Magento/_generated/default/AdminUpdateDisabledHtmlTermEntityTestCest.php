 ...
 * @Description("Admin should be able to update disabled HTML checkout agreement<h3>Test files</h3>vendor\magento\module-checkout-agreements\Test\Mftf\Test\AdminUpdateDisabledHtmlTermEntityTest.xml<br>")
 * @TestCaseId("MC-14664")
