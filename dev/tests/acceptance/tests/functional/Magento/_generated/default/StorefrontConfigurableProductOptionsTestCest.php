 ...
 * @Description("Guest customer should be able to see product configuration options<h3>Test files</h3>vendor\magento\module-configurable-product\Test\Mftf\Test\StorefrontConfigurableProductDetailsTest\StorefrontConfigurableProductOptionsTest.xml<br>")
 * @TestCaseId("MC-92")
...
class StorefrontConfigurableProductOptionsTestCest
{
	...
	public function StorefrontConfigurableProductOptionsTest(AcceptanceTester $I)
	{
		...
		$I->see("1.00", "div.price-box.price-final_price"); // stepKey: seeProductPrice1
		...
		$I->see("2.00", "div.price-box.price-final_price"); // stepKey: seeProductPrice2
		$I->selectOption("#product-options-wrapper .super-attribute-select", "Blue" . msq("colorProductAttribute3")); // stepKey: selectOption3
		$I->dontSee("As low as", ".price-label"); // stepKey: dontSeeProductPriceLabel3
		$I->see("3.00", "div.price-box.price-final_price"); // stepKey: seeProductPrice3
	}
}
