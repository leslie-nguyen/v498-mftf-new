 ...
 * @Description("Admin should be able to create a CMS page with widget type: CMS page link<h3>Test files</h3>vendor\magento\module-cms\Test\Mftf\Test\AdminAddWidgetToWYSIWYGWithCMSPageLinkTypeTest.xml<br>")
