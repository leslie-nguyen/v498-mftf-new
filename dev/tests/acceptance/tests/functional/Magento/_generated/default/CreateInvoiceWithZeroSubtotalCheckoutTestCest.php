 ...
 * @Description("Create invoice with with zero subtotal checkout<h3>Test files</h3>vendor\magento\module-sales\Test\Mftf\Test\CreateInvoiceWithZeroSubtotalCheckoutTest.xml<br>")
 * @TestCaseId("MC-15871")
 * @group sales
 * @group mtf_migrated
 */
class CreateInvoiceWithZeroSubtotalCheckoutTestCest
{
	...
	public function CreateInvoiceWithZeroSubtotalCheckoutTest(AcceptanceTester $I)
	{
		...
		$I->see("The coupon code has been accepted.", "div.message-success:last-of-type"); // stepKey: seeSuccessMessageApplyCoupon
