 ...
 * @Description("Admin should be able to delete a product with custom option<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminDeleteProductWithCustomOptionTest.xml<br>")
 * @TestCaseId("MC-11015")
 * @group mtf_migrated
 */
