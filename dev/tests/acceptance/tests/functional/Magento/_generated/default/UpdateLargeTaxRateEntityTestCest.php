 ...
 * @Description("Test log in to Tax Rate and Update Large Rate<h3>Test files</h3>vendor\magento\module-tax\Test\Mftf\Test\UpdateLargeTaxRateEntityTest.xml<br>")
 * @TestCaseId("MC-5330")
 * @group tax
 * @group mtf_migrated
 */
class UpdateLargeTaxRateEntityTestCest
{
	...
	public function UpdateLargeTaxRateEntityTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#tax_rate_grid_filter_code", "TaxRate" . msq("defaultTaxRateWithLargeRate")); // stepKey: fillTaxIdentifierField3
