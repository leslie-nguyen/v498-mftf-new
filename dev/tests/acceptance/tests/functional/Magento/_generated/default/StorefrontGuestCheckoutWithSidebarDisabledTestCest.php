 ...
 * @Description("Should be able to place an order as a Guest when Cart sidebar is disabled<h3>Test files</h3>vendor\magento\module-checkout\Test\Mftf\Test\StorefrontGuestCheckoutTest\StorefrontGuestCheckoutWithSidebarDisabledTest.xml<br>")
 * @TestCaseId("MC-16587")
 * @group checkout
 */
class StorefrontGuestCheckoutWithSidebarDisabledTestCest
{
	...
	public function StorefrontGuestCheckoutWithSidebarDisabledTest(AcceptanceTester $I)
	{
		...
		$I->click("main .action.primary.checkout span"); // stepKey: goToCheckoutGuestGoToCheckoutFromCart
