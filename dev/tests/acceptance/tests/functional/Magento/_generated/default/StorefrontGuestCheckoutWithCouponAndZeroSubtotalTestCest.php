 ...
 * @Description("Checkout with virtual product using coupon for not logged in customers with Zero Subtotal<h3>Test files</h3>vendor\magento\module-checkout\Test\Mftf\Test\StorefrontGuestCheckoutWithCouponAndZeroSubtotalTest.xml<br>")
 * @TestCaseId("MC-14710")
 * @group mtf_migrated
 */
class StorefrontGuestCheckoutWithCouponAndZeroSubtotalTestCest
{
	...
	public function StorefrontGuestCheckoutWithCouponAndZeroSubtotalTest(AcceptanceTester $I)
	{
		...
		$I->see("-$50.00", "td[data-th='Discount']"); // stepKey: seeDiscountTotal
