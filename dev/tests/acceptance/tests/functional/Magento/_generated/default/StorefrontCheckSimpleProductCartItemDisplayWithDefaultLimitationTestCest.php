 ...
 * @Description("Add 10 SimpleProducts to the cart and check cart display with default display limit<h3>Test files</h3>vendor\magento\module-checkout\Test\Mftf\Test\StorefrontCheckSimpleProductCartItemDisplayWithDefaultLimitationTest.xml<br>")
 * @TestCaseId("MC-14723")
 * @group mtf_migrated
 */
class StorefrontCheckSimpleProductCartItemDisplayWithDefaultLimitationTestCest
{
	...
	public function StorefrontCheckSimpleProductCartItemDisplayWithDefaultLimitationTest(AcceptanceTester $I)
	{
		...
		$I->see("10 of 11 Items in Cart", "//div[@class='title']"); // stepKey: seeOrderSummaryTextAssertItemsCountInOrderSummary
