 ...
 * @Description("Login as admin,verify UrlRewrite auto update when subcategory is deleted<h3>Test files</h3>vendor\magento\module-url-rewrite\Test\Mftf\Test\AdminAutoUpdateURLRewriteWhenCategoryIsDeletedTest.xml<br>")
 * @TestCaseId("MC-5342")
 * @group mtf_migrated
 */
class AdminAutoUpdateURLRewriteWhenCategoryIsDeletedTestCest
{
	...
	public function AdminAutoUpdateURLRewriteWhenCategoryIsDeletedTest(AcceptanceTester $I)
	{
		...
		$I->fillField("//input[@id='request_path']", "testurlkey" . msq("_defaultProduct") . ".html"); // stepKey: fillRequestPathAddUrlRewriteForProduct
		...
		$I->fillField(".admin__data-grid-filters input[name='request_path']", $I->retrieveEntityField('createSimpleProduct', 'name', 'test') . ".html"); // stepKey: fillRedirectPathFilterSearchByRequestPath
		...
		$I->see($I->retrieveEntityField('createSimpleProduct', 'name', 'test') . ".html", "//*[@data-role='grid']//tbody//tr[1+1]//td[count(//*[@data-role='grid']//th[contains(., 'Request Path')]/preceding-sibling::th)+1]"); // stepKey: seeTheRedirectPathForOldUrlSearchByRequestPath
		...
		$I->fillField(".admin__data-grid-filters input[name='request_path']", "testurlkey" . msq("_defaultProduct") . ".html"); // stepKey: fillRedirectPathFilterSearchByRequestPath1
		...
		$I->see("testurlkey" . msq("_defaultProduct") . ".html", "//*[@data-role='grid']//tbody//tr[1+1]//td[count(//*[@data-role='grid']//th[contains(., 'Request Path')]/preceding-sibling::th)+1]"); // stepKey: seeTheRedirectPathForOldUrlSearchByRequestPath1
		$I->see($I->retrieveEntityField('createSimpleProduct', 'name', 'test') . ".html", "//*[@data-role='grid']//tbody//tr[1+1]//td[count(//*[@data-role='grid']//th[contains(., 'Target Path')]/preceding-sibling::th)+1]"); // stepKey: seeTheTargetPathSearchByRequestPath1
		...
		$I->fillField(".admin__data-grid-filters input[name='request_path']", $I->retrieveEntityField('createCategory', 'name', 'test') . ".html"); // stepKey: fillRedirectPathFilterSearchDeletedCategory
