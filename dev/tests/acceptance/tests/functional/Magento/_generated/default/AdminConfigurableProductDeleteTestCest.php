 ...
 * @Description("admin should be able to delete a configurable product<h3>Test files</h3>vendor\magento\module-configurable-product\Test\Mftf\Test\AdminConfigurableProductDeleteTest\AdminConfigurableProductDeleteTest.xml<br>")
 * @TestCaseId("MC-87")
...
class AdminConfigurableProductDeleteTestCest
{
	...
	public function AdminConfigurableProductDeleteTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage($I->retrieveEntityField('createConfigProduct', 'sku', 'test') . ".html"); // stepKey: gotoStorefront1
		...
		$I->amOnPage($I->retrieveEntityField('createConfigProduct', 'sku', 'test') . ".html"); // stepKey: gotoStorefront2
