 ...
 * @Description("Test log in to Update Virtual Product and Update Virtual Product with Tier Price (Out of Stock) Visible in Category and Search<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminUpdateVirtualProductWithTierPriceOutOfStockVisibleInCategoryAndSearchTest.xml<br>")
 * @TestCaseId("MC-6499")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateVirtualProductWithTierPriceOutOfStockVisibleInCategoryAndSearchTestCest
{
	...
	public function AdminUpdateVirtualProductWithTierPriceOutOfStockVisibleInCategoryAndSearchTest(AcceptanceTester $I)
	{
		...
		$I->waitForPageLoad(30); // stepKey: waitForStoreFrontProductPageLoad
		$I->fillField("#search", "virtual_sku" . msq("updateVirtualTierPriceOutOfStock")); // stepKey: fillVirtualProductName
		...
		$I->dontSee("VirtualProduct" . msq("updateVirtualTierPriceOutOfStock"), "a[class='product-item-link']"); // stepKey: dontSeeVirtualProductName
