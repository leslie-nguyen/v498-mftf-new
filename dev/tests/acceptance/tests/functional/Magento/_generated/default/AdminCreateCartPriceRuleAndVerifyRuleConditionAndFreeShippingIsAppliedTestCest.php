 ...
 * @Description("Test log in to Cart Price Rules and Create Cart Price Rule And Verify Rule Condition And Free Shipping Is Applied<h3>Test files</h3>vendor\magento\module-sales-rule\Test\Mftf\Test\AdminCreateCartPriceRuleAndVerifyRuleConditionAndFreeShippingIsAppliedTest.xml<br>")
 * @TestCaseId("MC-15604")
 * @group SalesRule
 * @group mtf_migrated
 */
class AdminCreateCartPriceRuleAndVerifyRuleConditionAndFreeShippingIsAppliedTestCest
{
	...
	public function AdminCreateCartPriceRuleAndVerifyRuleConditionAndFreeShippingIsAppliedTest(AcceptanceTester $I)
	{
		...
		$I->see("-$280.00", "td[data-th='Discount']"); // stepKey: seeAssertDiscountAmountAppliedForMatchingItemsConditionIsTrue
	}
}
