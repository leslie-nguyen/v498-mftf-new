 ...
 * @Description("Test log in to Create tax rule and Create tax rule with New and Existing Tax Rate, Customer Tax Class, Product Tax Class<h3>Test files</h3>vendor\magento\module-tax\Test\Mftf\Test\AdminCreateTaxRuleWithNewAndExistingTaxRateAndCustomerAndProductTaxClassTest.xml<br>")
 * @TestCaseId("MC-5327")
 * @group tax
 * @group mtf_migrated
 */
