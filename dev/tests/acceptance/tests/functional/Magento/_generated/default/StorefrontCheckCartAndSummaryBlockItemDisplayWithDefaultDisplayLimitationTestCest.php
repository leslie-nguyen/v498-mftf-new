 ...
 * @Description("Add 10 items to the cart and check cart and summary block display with default display limit<h3>Test files</h3>vendor\magento\module-checkout\Test\Mftf\Test\StorefrontCheckCartAndSummaryBlockItemDisplayWithDefaultDisplayLimitationTest.xml<br>")
 * @TestCaseId("MC-14722")
 * @group mtf_migrated
 */
class StorefrontCheckCartAndSummaryBlockItemDisplayWithDefaultDisplayLimitationTestCest
{
	...
	public function StorefrontCheckCartAndSummaryBlockItemDisplayWithDefaultDisplayLimitationTest(AcceptanceTester $I)
	{
		...
		$I->see("10 Items in Cart", "//div[@class='title']"); // stepKey: seeOrderSummaryTextAssertOrderSummary
