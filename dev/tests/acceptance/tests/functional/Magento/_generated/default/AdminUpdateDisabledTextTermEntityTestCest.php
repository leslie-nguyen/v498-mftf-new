 ...
 * @Description("Admin should be able to update disabled Text checkout agreement<h3>Test files</h3>vendor\magento\module-checkout-agreements\Test\Mftf\Test\AdminUpdateDisabledTextTermEntityTest.xml<br>")
 * @TestCaseId("MC-14665")
