 ...
 * @Description("Admin should be able to create downloadable product with manage stock<h3>Test files</h3>vendor\magento\module-downloadable\Test\Mftf\Test\AdminCreateDownloadableProductWithManageStockTest.xml<br>")
 * @TestCaseId("MC-14510")
 * @group Downloadable
 * @group mtf_migrated
 */
