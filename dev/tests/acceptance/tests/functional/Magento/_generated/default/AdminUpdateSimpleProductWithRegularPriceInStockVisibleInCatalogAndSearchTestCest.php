 ...
 * @Description("Test log in to Update Simple Product and Update Simple Product with Regular Price (In Stock) Visible in Catalog and Search<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminUpdateSimpleProductWithRegularPriceInStockVisibleInCatalogAndSearchTest.xml<br>")
 * @TestCaseId("MC-10802")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateSimpleProductWithRegularPriceInStockVisibleInCatalogAndSearchTestCest
{
	...
	public function AdminUpdateSimpleProductWithRegularPriceInStockVisibleInCatalogAndSearchTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage("/test-simple-product" . msq("simpleProductRegularPrice245InStock") . ".html"); // stepKey: goToProductPage
		$I->waitForPageLoad(30); // stepKey: waitForStorefrontProductPageLoad
		$I->see("TestSimpleProduct" . msq("simpleProductRegularPrice245InStock"), ".base"); // stepKey: seeSimpleProductNameOnStoreFrontPage
		...
		$I->waitForPageLoad(30); // stepKey: waitForStoreFrontProductPageLoad
		$I->fillField("#search", "test_simple_product_sku" . msq("simpleProductRegularPrice245InStock")); // stepKey: fillSimpleProductSkuInSearchTextBox
		...
		$I->see("TestSimpleProduct" . msq("simpleProductRegularPrice245InStock"), "a[class='product-item-link']"); // stepKey: seeSimpleProductNameOnStorefrontPage
		$I->waitForPageLoad(30); // stepKey: seeSimpleProductNameOnStorefrontPageWaitForPageLoad
	}
}
