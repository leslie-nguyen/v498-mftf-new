 ...
 * @Description("Admin should be able to create a catalog price rule applied as a percentage of original (for simple product)<h3>Test files</h3>vendor\magento\module-catalog-rule\Test\Mftf\Test\AdminCreateCatalogPriceRuleTest\AdminCreateCatalogPriceRuleByPercentTest.xml<br>")
 * @TestCaseId("MC-65")
 * @group CatalogRule
 */
