 ...
 * @Description("Admin should be able to create a CMS page with widget type: Recently Viewed Products<h3>Test files</h3>vendor\magento\module-cms\Test\Mftf\Test\AdminAddWidgetToWYSIWYGWithRecentlyViewedProductsTypeTest.xml<br>")
