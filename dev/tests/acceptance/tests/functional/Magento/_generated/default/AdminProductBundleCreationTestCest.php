 ...
 * @Description("Admin should be able to save and publish a bundle product<h3>Test files</h3>vendor\magento\module-bundle\Test\Mftf\Test\AdminProductBundleCreationTest.xml<br>")
 * @TestCaseId("MC-225")
 * @group Bundle
 */
