 ...
 * @Description("Test log in to Update Simple Product and Update Simple Product with Regular Price (In Stock) Visible in Catalog Only<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminUpdateSimpleProductWithRegularPriceInStockVisibleInCatalogOnlyTest.xml<br>")
 * @TestCaseId("MC-10804")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateSimpleProductWithRegularPriceInStockVisibleInCatalogOnlyTestCest
{
	...
	public function AdminUpdateSimpleProductWithRegularPriceInStockVisibleInCatalogOnlyTest(AcceptanceTester $I)
	{
		...
		$I->fillField(".admin__field[data-index=name] input", "TestSimpleProduct" . msq("simpleProductRegularPrice32501InStock")); // stepKey: fillSimpleProductName
		$I->fillField(".admin__field[data-index=sku] input", "test_simple_product_sku" . msq("simpleProductRegularPrice32501InStock")); // stepKey: fillSimpleProductSku
		$I->fillField(".admin__field[data-index=price] input", "325.01"); // stepKey: fillSimpleProductPrice
		$I->fillField(".admin__field[data-index=qty] input", "125"); // stepKey: fillSimpleProductQuantity
		...
		$I->fillField(".admin__field[data-index=weight] input", "25"); // stepKey: fillSimpleProductWeight
		...
		$I->fillField("input[name='product[url_key]']", "test-simple-product" . msq("simpleProductRegularPrice32501InStock")); // stepKey: fillUrlKey
		...
		$I->fillField("input.admin__control-text[name='name']", "TestSimpleProduct" . msq("simpleProductRegularPrice32501InStock")); // stepKey: fillSimpleProductNameInNameFilter
		$I->fillField("input.admin__control-text[name='sku']", "test_simple_product_sku" . msq("simpleProductRegularPrice32501InStock")); // stepKey: fillProductSku
		...
		$I->seeInField(".admin__field[data-index=name] input", "TestSimpleProduct" . msq("simpleProductRegularPrice32501InStock")); // stepKey: seeSimpleProductName
		$I->seeInField(".admin__field[data-index=sku] input", "test_simple_product_sku" . msq("simpleProductRegularPrice32501InStock")); // stepKey: seeSimpleProductSku
		$I->seeInField(".admin__field[data-index=price] input", "325.01"); // stepKey: seeSimpleProductPrice
		$I->seeInField(".admin__field[data-index=qty] input", "125"); // stepKey: seeSimpleProductQuantity
		...
		$I->seeInField(".admin__field[data-index=weight] input", "25"); // stepKey: seeSimpleProductWeight
		...
		$I->see("TestSimpleProduct" . msq("simpleProductRegularPrice32501InStock"), "a.product-item-link"); // stepKey: seeSimpleProductNameOnCategoryPage
		...
		$I->amOnPage("/test-simple-product" . msq("simpleProductRegularPrice32501InStock") . ".html"); // stepKey: goToProductPage
		$I->waitForPageLoad(30); // stepKey: waitForStorefrontProductPageLoad
		$I->see("TestSimpleProduct" . msq("simpleProductRegularPrice32501InStock"), ".base"); // stepKey: seeSimpleProductNameOnStoreFrontPage
		$I->see("325.01", "div.price-box.price-final_price"); // stepKey: seeSimpleProductPriceOnStoreFrontPage
		...
		$I->assertEquals("$325.01", $productPriceAmount); // stepKey: assertOldPriceTextOnProductPage
		$I->comment("Verify customer don't see updated simple product link on magento storefront page and is searchable by sku");
		$I->amOnPage("/test-simple-product" . msq("simpleProductRegularPrice32501InStock") . ".html"); // stepKey: goToMagentoStorefrontPage
		$I->waitForPageLoad(30); // stepKey: waitForStoreFrontProductPageLoad
		$I->fillField("#search", "test_simple_product_sku" . msq("simpleProductRegularPrice32501InStock")); // stepKey: fillSimpleProductSkuInSearchTextBox
		...
		$I->dontSee("TestSimpleProduct" . msq("simpleProductRegularPrice32501InStock"), "a[class='product-item-link']"); // stepKey: dontSeeProductName
		$I->waitForPageLoad(30); // stepKey: dontSeeProductNameWaitForPageLoad
	}
}
