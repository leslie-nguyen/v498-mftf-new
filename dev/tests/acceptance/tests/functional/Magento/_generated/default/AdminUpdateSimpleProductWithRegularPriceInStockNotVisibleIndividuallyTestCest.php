 ...
 * @Description("Test log in to Update Simple Product and Update Simple Product with Regular Price (In Stock) Not Visible Individually<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminUpdateSimpleProductWithRegularPriceInStockNotVisibleIndividuallyTest.xml<br>")
 * @TestCaseId("MC-10803")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateSimpleProductWithRegularPriceInStockNotVisibleIndividuallyTestCest
{
	...
	public function AdminUpdateSimpleProductWithRegularPriceInStockNotVisibleIndividuallyTest(AcceptanceTester $I)
	{
		...
		$I->fillField(".admin__field[data-index=name] input", "TestSimpleProduct" . msq("simpleProductNotVisibleIndividually")); // stepKey: fillSimpleProductName
		$I->fillField(".admin__field[data-index=sku] input", "test_simple_product_sku" . msq("simpleProductNotVisibleIndividually")); // stepKey: fillSimpleProductSku
		$I->fillField(".admin__field[data-index=price] input", "325.00"); // stepKey: fillSimpleProductPrice
		$I->fillField(".admin__field[data-index=qty] input", "123"); // stepKey: fillSimpleProductQuantity
		...
		$I->fillField(".admin__field[data-index=weight] input", "129.0000"); // stepKey: fillSimpleProductWeight
		...
		$I->fillField("input[name='product[url_key]']", "test-simple-product" . msq("simpleProductNotVisibleIndividually")); // stepKey: fillSimpleProductUrlKey
		...
		$I->fillField("input.admin__control-text[name='name']", "TestSimpleProduct" . msq("simpleProductNotVisibleIndividually")); // stepKey: fillSimpleProductNameInNameFilter
		$I->fillField("input.admin__control-text[name='sku']", "test_simple_product_sku" . msq("simpleProductNotVisibleIndividually")); // stepKey: fillProductSku
		...
		$I->seeInField(".admin__field[data-index=name] input", "TestSimpleProduct" . msq("simpleProductNotVisibleIndividually")); // stepKey: seeSimpleProductName
		$I->seeInField(".admin__field[data-index=sku] input", "test_simple_product_sku" . msq("simpleProductNotVisibleIndividually")); // stepKey: seeSimpleProductSku
		$I->seeInField(".admin__field[data-index=price] input", "325.00"); // stepKey: seeSimpleProductPrice
		$I->seeInField(".admin__field[data-index=qty] input", "123"); // stepKey: seeSimpleProductQuantity
		...
		$I->seeInField(".admin__field[data-index=weight] input", "129"); // stepKey: seeSimpleProductWeight
		...
		$I->seeInField("//select[@name='product[visibility]']", "Not Visible Individually"); // stepKey: seeSimpleProductVisibility
		...
		$I->amOnPage("/test-simple-product" . msq("simpleProductNotVisibleIndividually") . ".html"); // stepKey: goToMagentoStorefrontPage
		$I->waitForPageLoad(30); // stepKey: waitForStoreFrontProductPageLoad
		$I->fillField("#search", "test_simple_product_sku" . msq("simpleProductNotVisibleIndividually")); // stepKey: fillSimpleProductSkuInSearchTextBox
		...
		$I->dontSee("TestSimpleProduct" . msq("simpleProductNotVisibleIndividually"), "a[class='product-item-link']"); // stepKey: dontSeeSimpleProductNameOnMagentoStorefrontPage
		$I->waitForPageLoad(30); // stepKey: dontSeeSimpleProductNameOnMagentoStorefrontPageWaitForPageLoad
	}
}
