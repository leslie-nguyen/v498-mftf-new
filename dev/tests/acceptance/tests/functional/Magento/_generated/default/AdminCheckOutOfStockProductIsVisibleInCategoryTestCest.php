 ...
 * @Description("Login as admin and check out of stock product is visible in category<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminCheckOutOfStockProductIsVisibleInCategoryTest.xml<br>")
 * @TestCaseId("MC-11067")
 * @group mtf_migrated
 */
class AdminCheckOutOfStockProductIsVisibleInCategoryTestCest
{
	...
	public function AdminCheckOutOfStockProductIsVisibleInCategoryTest(AcceptanceTester $I)
	{
		...
		$I->see("SimpleProduct" . msq("SimpleProduct"), ".product-item-name"); // stepKey: seeProductNameSeeProductName
