 ...
 * @Description("Admin should be able to add default images for a Configurable Product<h3>Test files</h3>vendor\magento\module-configurable-product\Test\Mftf\Test\AdminAddDefaultImageConfigurableTest.xml<br>")
 * @TestCaseId("MC-101")
