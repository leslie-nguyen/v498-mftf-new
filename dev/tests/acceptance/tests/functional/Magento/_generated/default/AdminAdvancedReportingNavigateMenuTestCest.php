 ...
 * @Description("Admin should be able to navigate through advanced reporting admin menu to BI reports page<h3>Test files</h3>vendor\magento\module-analytics\Test\Mftf\Test\AdminAdvancedReportingNavigateMenuTest.xml<br>")
 * @TestCaseId("MC-14152")
 * @group menu
 * @group mtf_migrated
 */
class AdminAdvancedReportingNavigateMenuTestCest
{
	...
	public function AdminAdvancedReportingNavigateMenuTest(AcceptanceTester $I)
	{
		...
		$I->switchToNextTab(); // stepKey: switchToNewTab
		$I->waitForPageLoad(30); // stepKey: waitForAdvancedReportingPageLoad
		$I->seeInCurrentUrl("advancedreporting.rjmetrics.com/report"); // stepKey: seeAssertAdvancedReportingPageUrl
	}
}
