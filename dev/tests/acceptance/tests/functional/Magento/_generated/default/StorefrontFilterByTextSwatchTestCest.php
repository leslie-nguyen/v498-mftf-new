 ...
 * @Description("Customers can filter products using text swatches<h3>Test files</h3>vendor\magento\module-swatches\Test\Mftf\Test\StorefrontFilterByTextSwatchTest.xml<br>")
 * @TestCaseId("MC-3462")
 * @group Swatches
 */
