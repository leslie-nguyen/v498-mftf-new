 ...
 * @Description("Admin should not be able to submit orders without invalid address fields<h3>Test files</h3>vendor\magento\module-sales\Test\Mftf\Test\AdminSubmitsOrderWithAndWithoutFieldsValidationTest.xml<br>")
 * @group sales
 */
