 ...
 * @Description("Test log in to Update Virtual Product and Update Virtual Product with Regular Price (Out of Stock) Visible in Category Only<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminUpdateVirtualProductWithRegularPriceOutOfStockVisibleInCategoryOnlyTest.xml<br>")
 * @TestCaseId("MC-6503")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateVirtualProductWithRegularPriceOutOfStockVisibleInCategoryOnlyTestCest
{
	...
	public function AdminUpdateVirtualProductWithRegularPriceOutOfStockVisibleInCategoryOnlyTest(AcceptanceTester $I)
	{
		...
		$I->waitForPageLoad(30); // stepKey: waitForStoreFrontProductPageLoad
		$I->fillField("#search", "virtual_sku" . msq("updateVirtualProductRegularPrice5OutOfStock")); // stepKey: fillVirtualProductName
		...
		$I->dontSee("VirtualProduct" . msq("updateVirtualProductRegularPrice5OutOfStock"), "a[class='product-item-link']"); // stepKey: dontSeeVirtualProductName
