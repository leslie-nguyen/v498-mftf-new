 ...
 * @Description("Release order in status On Hold<h3>Test files</h3>vendor\magento\module-sales\Test\Mftf\Test\AdminOrdersReleaseInUnholdStatusTest.xml<br>")
 * @TestCaseId("MC-16187")
 * @group sales
 * @group mtf_migrated
 */
class AdminOrdersReleaseInUnholdStatusTestCest
{
	...
	public function AdminOrdersReleaseInUnholdStatusTest(AcceptanceTester $I)
	{
		...
		$I->comment("Hold Order");
		$I->click("#order-view-hold-button"); // stepKey: pushButtonHold
		$I->waitForPageLoad(30); // stepKey: pushButtonHoldWaitForPageLoad
		$I->waitForPageLoad(30); // stepKey: waitForHold
		$I->see("You put the order on hold."); // stepKey: seeHoldMessage
		...
		$I->checkOption("//td/div[text()='$getOrderId']/../preceding-sibling::td//input"); // stepKey: selectOrderActionUnold
