 ...
 * @Description("Admin should be able to create downloadable product with default set links<h3>Test files</h3>vendor\magento\module-downloadable\Test\Mftf\Test\AdminCreateDownloadableProductWithDefaultSetLinksTest.xml<br>")
 * @TestCaseId("MC-14507")
 * @group Downloadable
 * @group mtf_migrated
 */
class AdminCreateDownloadableProductWithDefaultSetLinksTestCest
{
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->comment("Reindex and clear page cache");
