 ...
 * @Description("Admin should be able to create active HTML checkout agreement<h3>Test files</h3>vendor\magento\module-checkout-agreements\Test\Mftf\Test\AdminCreateActiveHtmlTermEntityTest.xml<br>")
 * @TestCaseId("MC-14668")
