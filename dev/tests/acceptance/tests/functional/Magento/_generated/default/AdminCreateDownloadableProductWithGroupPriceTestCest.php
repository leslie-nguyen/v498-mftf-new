 ...
 * @Description("Admin should be able to create downloadable product with group price<h3>Test files</h3>vendor\magento\module-downloadable\Test\Mftf\Test\AdminCreateDownloadableProductWithGroupPriceTest.xml<br>")
 * @TestCaseId("MC-14514")
 * @group Downloadable
 * @group mtf_migrated
 */
