 ...
 * @Description("Login as admin and create inactive Include In Menu flat category and verify category is not displayed in Navigation Menu<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminCreateInactiveInMenuFlatCategoryTest.xml<br>")
 * @TestCaseId("MC-11008")
 * @group mtf_migrated
 */
class AdminCreateInactiveInMenuFlatCategoryTestCest
{
	...
	public function AdminCreateInactiveInMenuFlatCategoryTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage("/" . $I->retrieveEntityField('category', 'name', 'test') . ".html"); // stepKey: openCategoryPage1
