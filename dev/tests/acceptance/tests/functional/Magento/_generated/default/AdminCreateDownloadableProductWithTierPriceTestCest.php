 ...
 * @Description("Admin should be able to create downloadable with tier price<h3>Test files</h3>vendor\magento\module-downloadable\Test\Mftf\Test\AdminCreateDownloadableProductWithTierPriceTest.xml<br>")
 * @TestCaseId("MC-14515")
 * @group Downloadable
 * @group mtf_migrated
 */
