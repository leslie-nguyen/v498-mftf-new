 ...
 * @Description("Admin should not be able to create a product with a negative price<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminCreateSimpleProductTest\AdminCreateSimpleProductNegativePriceTest.xml<br>")
...
class AdminCreateSimpleProductNegativePriceTestCest
{
	...
	public function AdminCreateSimpleProductNegativePriceTest(AcceptanceTester $I)
	{
		...
		$I->fillField(".admin__field[data-index=price] input", "-42"); // stepKey: fillPrice
		...
		$I->see("Please enter a number 0 or greater in this field.", "//input[@name='product[price]']/parent::div/parent::div/label[@class='admin__field-error']"); // stepKey: seePriceValidationError
	}
}
