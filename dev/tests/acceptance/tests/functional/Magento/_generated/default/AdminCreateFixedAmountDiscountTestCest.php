 ...
 * @Description("Admin should be able to create a cart price rule of type Fixed amount discount<h3>Test files</h3>vendor\magento\module-sales-rule\Test\Mftf\Test\AdminCreateFixedAmountDiscountTest.xml<br>")
 * @TestCaseId("MC-62")
 * @group SalesRule
 */
