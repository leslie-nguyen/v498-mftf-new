 ...
 * @Description("Test log in to Update Virtual Product and Update Virtual Product with Special Price (Out of Stock) Visible in Category and Search<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminUpdateVirtualProductWithSpecialPriceOutOfStockVisibleInCategoryAndSearchTest.xml<br>")
 * @TestCaseId("MC-6505")
 * @group catalog
 * @group mtf_migrated
 */
class UpdateVirtualProductWithSpecialPriceOutOfStockVisibleInCategoryAndSearchTestCest
{
	...
	public function UpdateVirtualProductWithSpecialPriceOutOfStockVisibleInCategoryAndSearchTest(AcceptanceTester $I)
	{
		...
		$I->waitForPageLoad(30); // stepKey: waitForStoreFrontProductPageLoad
		$I->fillField("#search", "virtual_sku" . msq("updateVirtualProductSpecialPriceOutOfStock")); // stepKey: fillVirtualProductName
		...
		$I->dontSee("VirtualProduct" . msq("updateVirtualProductSpecialPriceOutOfStock"), "a[class='product-item-link']"); // stepKey: dontSeeVirtualProductNameOnStorefrontPage
		$I->waitForPageLoad(30); // stepKey: dontSeeVirtualProductNameOnStorefrontPageWaitForPageLoad
	}
}
