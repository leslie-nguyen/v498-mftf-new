 ...
 * @Description("Create an order with Zero Subtotal checkout and cancel the order<h3>Test files</h3>vendor\magento\module-sales\Test\Mftf\Test\AdminCancelTheCreatedOrderWithZeroSubtotalCheckoutTest.xml<br>")
 * @TestCaseId("MC-16067")
 */
class AdminCancelTheCreatedOrderWithZeroSubtotalCheckoutTestCest
{
	...
	public function _before(AcceptanceTester $I)
	{
		...
		$I->comment("Create a slaes rule with fixed discount");
