 ...
 * @Description("Admin should be able to update enabled Text checkout agreement<h3>Test files</h3>vendor\magento\module-checkout-agreements\Test\Mftf\Test\AdminUpdateEnabledTextTermEntityTest.xml<br>")
 * @TestCaseId("MC-14666")
