 ...
 * @Description("Admin should be able to delete a virtual product<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminDeleteVirtualProductTest.xml<br>")
 * @TestCaseId("MC-11014")
 * @group mtf_migrated
 */
class AdminDeleteVirtualProductTestCest
{
	...
	public function AdminDeleteVirtualProductTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage("/" . $I->retrieveEntityField('createVirtualProduct', 'name', 'test') . ".html"); // stepKey: amOnVirtualProductPage
