 ...
 * @Description("Login as Admin and create custom CMS page UrlRewrite and add Permanent redirect type and delete Permanent redirect URL rewrite<h3>Test files</h3>vendor\magento\module-url-rewrite\Test\Mftf\Test\AdminDeleteCMSPagePermanentRedirectUrlRewriteTest.xml<br>")
 * @TestCaseId("")
 * @group mtf_migrated
 */
