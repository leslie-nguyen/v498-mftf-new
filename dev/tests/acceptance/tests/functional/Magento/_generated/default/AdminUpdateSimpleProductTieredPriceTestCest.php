 ...
 * @Description("Test log in to Update Simple Product and Update Simple Product Tiered Price<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminUpdateSimpleProductTieredPriceTest.xml<br>")
 * @TestCaseId("MC-10824")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateSimpleProductTieredPriceTestCest
{
	...
	public function AdminUpdateSimpleProductTieredPriceTest(AcceptanceTester $I)
	{
		...
		$I->amOnPage("/test-simple-product" . msq("simpleProductTierPrice300InStock") . ".html"); // stepKey: goToProductPage
		$I->waitForPageLoad(30); // stepKey: waitForStorefrontProductPageLoad
		$I->see("TestSimpleProduct" . msq("simpleProductTierPrice300InStock"), ".base"); // stepKey: seeSimpleProductNameOnStoreFrontPage
		$I->see("300.00", "div.price-box.price-final_price"); // stepKey: seeSimpleProductPriceOnStoreFrontPage
		...
		$I->assertEquals("$300.00", $productPriceAmount); // stepKey: assertOldPriceTextOnProductPage
		...
		$I->waitForPageLoad(30); // stepKey: waitForStoreFrontProductPageLoad
		$I->fillField("#search", "test_simple_product_sku" . msq("simpleProductTierPrice300InStock")); // stepKey: fillSimpleProductSkuInSearchTextBox
		...
		$I->see("TestSimpleProduct" . msq("simpleProductTierPrice300InStock"), "a[class='product-item-link']"); // stepKey: seeProductName
