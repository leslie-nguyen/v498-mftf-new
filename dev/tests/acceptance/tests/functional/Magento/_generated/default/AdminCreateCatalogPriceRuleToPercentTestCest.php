 ...
 * @Description("Admin should be able to create a catalog price rule adjust final price to this percentage (for simple product)<h3>Test files</h3>vendor\magento\module-catalog-rule\Test\Mftf\Test\AdminCreateCatalogPriceRuleTest\AdminCreateCatalogPriceRuleToPercentTest.xml<br>")
 * @TestCaseId("MC-69")
 * @group CatalogRule
 */
