 ...
 * @Description("Admin should be able to create configurable product with tier price for one item<h3>Test files</h3>vendor\magento\module-configurable-product\Test\Mftf\Test\AdminCreateConfigurableProductWithTierPriceForOneItemTest.xml<br>")
 * @TestCaseId("MC-13695")
 * @group mtf_migrated
 */
