 ...
 * @Description("After selecting a configurable product when adding Admin should be switch to simple implicitly<h3>Test files</h3>vendor\magento\module-configurable-product\Test\Mftf\Test\AdminCreateAndSwitchProductType\AdminCreateConfigurableProductSwitchToSimpleTest.xml<br>")
 * @TestCaseId("MC-10926")
 * @group catalog
 * @group mtf_migrated
 */
