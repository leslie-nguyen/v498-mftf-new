 ...
 * @Description("Admin should be able to set/edit Related Products information when editing a simple product<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminSimpleSetEditRelatedProductsTest.xml<br>")
 * @TestCaseId("MC-3411")
 * @group Catalog
 */
class AdminSimpleSetEditRelatedProductsTestCest
{
	...
	public function AdminSimpleSetEditRelatedProductsTest(AcceptanceTester $I)
	{
		...
		$I->fillField(".admin__field[data-index=name] input", "simple" . msq("SimpleProduct3")); // stepKey: fillProductNameFillProductForm
		$I->fillField(".admin__field[data-index=sku] input", "simple" . msq("SimpleProduct3")); // stepKey: fillProductSkuFillProductForm
		...
		$I->amOnPage("simple" . msq("SimpleProduct3") . ".html"); // stepKey: goToStorefront
