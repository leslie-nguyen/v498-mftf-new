...
/**
 * @Description("Check display a CMS page<h3>Test files</h3>app\code\Cafedu\Theme\Test\Mftf\Test\CMSPageTest.xml<br>")
 * @TestCaseId("QUICK-CMS01")
 * @group QuickGoThrough
 */
class CMSPageTestCest
{
    /**
	...
	/**
	 * @Features({"Theme"})
	 * @Stories({"Check display a CMS page"})
	 ...
	 * @throws \Exception
	 */
	public function CMSPageTest(AcceptanceTester $I)
	{
		$I->comment("Access CMS page");
		...
		$I->amOnPage("/en_row/orders-returns"); // stepKey: redirectToTargetPageAccessPageAndVerifyJSError
 ...
 so there will be no needed to verify in this action group anymore");
		...
		$I->comment("Verify main CMS page");
		...
		$I->makeScreenshot("CMSPageScreenshot"); // stepKey: screenshotCMSPage
