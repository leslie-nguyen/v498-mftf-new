 ...
 * @Description("For a product with category that has parent anchor categories, the rewrites is created when the category/product is saved.<h3>Test files</h3>vendor\magento\module-url-rewrite\Test\Mftf\Test\AdminUrlRewritesForProductInAnchorCategoriesTest\AdminUrlRewritesForProductInAnchorCategoriesTest.xml<br>")
 * @TestCaseId("MC-16568")
 * @group urlRewrite
 */
