 ...
 * @Description("Test log in to Tax Rate and Update 12.99 Rate<h3>Test files</h3>vendor\magento\module-tax\Test\Mftf\Test\Update1299TaxRateEntityTest.xml<br>")
 * @TestCaseId("MC-5332")
 * @group tax
 * @group mtf_migrated
 */
class Update1299TaxRateEntityTestCest
{
	...
	public function Update1299TaxRateEntityTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#tax_rate_grid_filter_code", $I->retrieveEntityField('initialTaxRate', 'code', 'test')); // stepKey: fillCode1
		...
		$I->fillField("#tax_rate_grid_filter_code", "TaxRate" . msq("taxRateCustomRateUK")); // stepKey: fillTaxIdentifierField2
