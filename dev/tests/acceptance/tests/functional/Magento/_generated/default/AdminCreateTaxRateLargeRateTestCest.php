 ...
 * @Description("Test log in to Create Tax Rate and Create Large Rate<h3>Test files</h3>vendor\magento\module-tax\Test\Mftf\Test\AdminCreateTaxRateLargeRateTest.xml<br>")
 * @TestCaseId("MC-5322")
 * @group tax
 * @group mtf_migrated
 */
