 ...
 * @Description("Admin should be able to create a catalog price rule adjust final price to discount value (for simple product)<h3>Test files</h3>vendor\magento\module-catalog-rule\Test\Mftf\Test\AdminCreateCatalogPriceRuleTest\AdminCreateCatalogPriceRuleToFixedTest.xml<br>")
 * @TestCaseId("MC-60")
 * @group CatalogRule
 */
