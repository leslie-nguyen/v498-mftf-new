 ...
 * @Description("Test log in to Update Virtual Product and Update Virtual Product with Tier Price (In Stock) Visible in Category Only<h3>Test files</h3>vendor\magento\module-catalog\Test\Mftf\Test\AdminUpdateVirtualProductWithTierPriceInStockVisibleInCategoryOnlyTest.xml<br>")
 * @TestCaseId("MC-7508")
 * @group catalog
 * @group mtf_migrated
 */
class AdminUpdateVirtualProductWithTierPriceInStockVisibleInCategoryOnlyTestCest
{
	...
	public function AdminUpdateVirtualProductWithTierPriceInStockVisibleInCategoryOnlyTest(AcceptanceTester $I)
	{
		...
		$I->waitForPageLoad(30); // stepKey: waitForStoreFrontProductPageLoad
		$I->fillField("#search", "virtual_sku" . msq("updateVirtualProductTierPriceInStock")); // stepKey: fillVirtualProductName
		...
		$I->dontSee("VirtualProduct" . msq("updateVirtualProductWithTierPriceInStock"), "a[class='product-item-link']"); // stepKey: dontSeeVirtualProductName
