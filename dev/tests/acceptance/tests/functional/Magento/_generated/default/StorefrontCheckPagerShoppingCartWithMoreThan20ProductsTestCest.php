 ...
 * @Description("Test if the cart pager is visible with more than 20 cart items and the pager disappears if an item is removed from cart.<h3>Test files</h3>vendor\magento\module-checkout\Test\Mftf\Test\StorefrontCheckPagerShoppingCartWithMoreThan20ProductsTest.xml<br>")
 * @TestCaseId("MC-14700")
 * @group shoppingCart
 * @group mtf_migrated
 */
