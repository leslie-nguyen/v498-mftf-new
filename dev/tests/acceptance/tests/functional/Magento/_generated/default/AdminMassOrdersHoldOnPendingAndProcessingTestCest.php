 ...
 * @Description("Put orders in statuses Pending, Processing on Hold<h3>Test files</h3>vendor\magento\module-sales\Test\Mftf\Test\AdminMassOrdersHoldOnPendingAndProcessingTest.xml<br>")
 * @TestCaseId("MC-16185")
 * @group sales
 * @group mtf_migrated
 */
class AdminMassOrdersHoldOnPendingAndProcessingTestCest
{
	 ...
	 * @throws \Exception
	 */
	public function AdminMassOrdersHoldOnPendingAndProcessingTest(AcceptanceTester $I)
	{
		...
		$I->comment("Create Invoice for second Order");
