 ...
 * @Description("Admin should be able to create a cart price rule of type Buy X get Y free<h3>Test files</h3>vendor\magento\module-sales-rule\Test\Mftf\Test\AdminCreateBuyXGetYFreeTest.xml<br>")
 * @TestCaseId("MC-73")
 * @group SalesRule
 */
